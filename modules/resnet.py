...
class ResNet(nn.Module):
    ...
    def __init__(self,input_dim, block, layers, num_classes=1000):
        self.inplanes = 64
...
def resnet50(input_dim=3, pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """ 
    model = ResNet(input_dim, Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
